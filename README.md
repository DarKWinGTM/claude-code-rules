...
Latest refinement: ordinary answer tables now default to the selected light plain aligned no-frame style when a table is genuinely useful, while boxed/full-frame table defaults remain disallowed and list-first alternatives stay intact for sequence and simple status content.
