...
| Destructive action and topology gate | Stop unsafe deletion, overwrite, topology drift, incomplete cutover, discoverable quarantine, automatic fallback, and bad retry loops | `action-safety.md`, `coding-discipline.md`, `document-governance.md`, `document-integrity.md`, `evidence-discipline.md`, `authority-and-scope.md`, `accurate-communication.md`, `execution-and-goal-frame.md` |
...
| `execution-and-goal-frame.md` | authority collision resolver; destructive action and topology gate; communication and presentation calibration; execution continuity and worker routing; live execution surface arbitration; combined-rules execution-state orchestration |
