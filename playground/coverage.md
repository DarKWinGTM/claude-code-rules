...
| `action-safety.md` | safe refusal and recovery; destructive action and topology gate; workflow-blocked visual QA; authenticated capability and deterministic no-retry coverage |
...
| `coding-discipline.md` | destructive action and topology gate; coding change with verification discipline; status ladder and completion-claim audit |
...
| `document-governance.md` | destructive action and topology gate; governed artifact lifecycle; external, memory, and portability boundary |
...
| `execution-and-goal-frame.md` | authority collision resolver; destructive action and topology gate; communication and presentation calibration; execution continuity and worker routing; live execution surface arbitration; combined-rules execution-state orchestration; current-goal versus successor proof reachability |
