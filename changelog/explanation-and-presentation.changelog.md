...
### Changes
- Compressed repeated runtime wording in `explanation-and-presentation.md` while preserving the chain owner, operational contracts, and exact guard semantics.
