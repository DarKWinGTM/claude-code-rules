...
### Changes
- Updated `emergency-protocol.md` from v1.0 to v1.1.
- Updated `design/emergency-protocol.design.md` from v1.0 to v1.1.
- Added canonical root runtime header fields in active metadata order:
  - `Current Version`
  - `Design`
  - `Session`
  - `Full history`
- Preserved the existing emergency-protocol behavioral contract.

### Summary
Normalized runtime/design metadata to the cleanup-wave header standard without changing the substantive emergency-response policy.
