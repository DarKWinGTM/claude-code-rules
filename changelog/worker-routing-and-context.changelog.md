...
<a id="version-113"></a>
## Version 1.13: Added P137 Subagent-Driven-first execution routing refinement

**Date:** 2026-06-03
**Session:** 1f1873d2-0feb-485f-a5ff-d383254590dd

### Changes
- Updated `worker-routing-and-context.md` from v1.12 to v1.13.
- Updated `design/worker-routing-and-context.design.md` from v1.12 to v1.13.
- Added a Subagent-Driven-first execution default for selected non-trivial plan-backed or goal-backed work.
- Kept worker-routing as the topology owner, preferred standalone subagent lanes before Agent Team escalation, and preserved Inline Execution only as a checked direct-handling exception when more effective.
- Preserved leader verification, `/goal` objective ownership, and route-only plan support boundaries.

### Summary
`worker-routing-and-context.md` now defaults selected non-trivial plan/goal execution toward the smallest effective Subagent-Driven topology instead of surfacing an execution-style choice prompt by default.
...
<a id="version-111"></a>
## Version 1.11: Added P124 pre-goal helper-lane refinement

**Date:** 2026-05-29
**Session:** 1f1873d2-0feb-485f-a5ff-d383254590dd

### Changes
- Updated `worker-routing-and-context.md` from v1.10 to v1.11.
- Updated `design/worker-routing-and-context.design.md` from v1.10 to v1.11.
- Added goal-owned helper-lane guidance for conditional pre-goal planning support across analysis, route drafting, verification ordering, testing, and optional plan-file reference synthesis.
- Preserved minimally scoped helper use, internal-only posture, and leader-owned synthesis/proof verification.
- Preserved emitted or selected goal ownership so helper output remains route support rather than route authority or completion proof.

### Summary
`worker-routing-and-context.md` now makes pre-goal helper lanes explicit so native subagents can help shape route-heavy advisory `/goal` output without becoming a new public surface or a proof shortcut.
