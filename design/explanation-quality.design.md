...
- easy-to-picture phase/progress and phase-backed closeout explanation before denser governance or mechanism detail when the user is trying to understand what a phase is doing or delivered
...
### 7.2.4 Phase Closeout Delivery/Impact Pattern

When closing phase-backed work, start by explaining what the phase delivered in practical terms before deeper governance detail appears.
...
### 7.2.5 Stage/State Progression Pattern
...
### 7.2.6 Whole-Set Framing Pattern
...
### 7.2.7 Governing-Basis Clarification Pattern
...
### 7.2.8 Post-Compact Re-Anchor Pattern
...
### Pattern 5: Phase-backed closeout starts with practical delivery

```markdown
What this phase delivered
- It changed closeout reporting so phase completion explains what improved, not only which files were checked.
...
### Pattern 6: Governing-basis clarification before deep analysis
...
### Pattern 7: Layered walkthrough with snapshot in the middle
...
### Pattern 8: What it is / what it is not / now vs later
...
### Pattern 9: User-visible outcome summary
...
### Pattern 10: Patch-by-patch rollout with why each step exists
...
### Pattern 11: Full-set framing before narrowing
...
### Pattern 12: Move to the next stage when current scope is sufficient
...
### Pattern 13: Short recap after a long explanation
...
### Pattern 14: Variable and field explanation before deep reasoning
