...
This active-state model must preserve UDVC-1 while supporting first-class phased execution planning, explicit patch/review artifacts, completed documentation history surfaces for phase/patch/changelog scan-bloat control, first-class startup artifact initiation control, proactive external verification and source trust, evidence-seeking proof-aware reasoning so substantial analysis, design, recommendation, agreement, and disagreement use practical checked evidence when material while ordinary evidence remains grounding input rather than an automatic decision lock, native worker-agent routing and context control refined so pasted technical evidence is classified by user intent before project exploration, broad independent work is standalone-subagent-first, broad research/design-improvement/source-heavy recommendation work is decomposed into focused research lanes before leader raw source absorption, worker selection is capability-based rather than hardcoded by tool name, and Agent Team workflow remains an exceptional coordination escalation, first-class maintainable code structure and decomposition guidance refined with helper-function necessity and source-code comment discipline so coding-time work preserves responsibility clarity, avoids helper-function inflation, explains hidden process/business context when useful, and still avoids rigid line-count or architecture-template doctrine, portable implementation defaults, public onboarding/install portability, anti-hardcoding discipline, memory governance and session-boundary behavior, source-only semantic-preserving runtime rule compression with complete patch inventory coverage before execution, explicit runtime install/parity verification when installation is separately requested, completed P073-09 refreshed 43-file runtime semantic compression with 42,961 → 35,017 source words, 7,944 words reduced inside the accepted 7,580-7,944 range, source audits and 43/43 runtime parity passed, a runtime destination ownership boundary for co-located other-owner runtime files, phase-backed closeout reporting that states delivered work and impact before audit-only detail dominates, and design-to-phase execution synthesis plus lineage-first current-phase/subphase/new-major selection so sufficiently clear governed design can become phase execution order and current-phase live tasks when staged execution is warranted while phase-shaped follow-up work checks existing family lineage before opening a new major phase, first-class development verification/debug/TestKit strategy so non-trivial coding work carries a proportionate proof plan and evidence-calibrated closeout, non-trivial phase-backed live task entries visibly expose active or clearly implied phase context instead of relying on hidden internal alignment, and roadmap-aware completion behavior can recommend supported next phases or waves after true objective completion without interrupting selected safe continuation.
...
- P075-02 is the active v9.89 roadmap-aware completion refinement: it keeps the active runtime count at 44 while teaching closeout to recommend supported next phases/waves from checked roadmap surfaces after true objective completion, preserving selected safe continuation and keeping unselected future work advisory
...
The active runtime inventory contains 44 source-owned root rule files.

| # | Rule | Design Doc | Purpose |
|---|------|------------|---------|
| 1 | accurate-communication.md | accurate-communication.design.md v2.21 | Clear, context-complete, verification-honest, and evidence-threshold-aligned communication with proof-aware recommendation/design wording that separates checked evidence, assumptions, hard constraints, and open trade-offs, acknowledgement-without-endorsement wording, evidence-backed agreement, user-owned preference/direction separation, claim-focused contradiction guardrails, stronger human-language glosses, easy-explanation continuity so plain Thai explanations stay simple through the full answer, explicit clarification of variables/fields/config keys/internal labels when answers depend on them, duplicate-looking team-agent reporting honesty with observed-vs-inferred state separation, governing-basis clarification before deep branch analysis when multiple materially different policies/frames remain live, post-compact re-anchor wording for compacted-session continuation, memory-derived-context disclosure wording for path-matched remembered context, natural-professional wording guidance, direct human-readable action/result wording preference over metaphor-heavy internal shorthand, explicit main-point-first operational framing for diagnosis/test/recommendation/proposal/update answers, coding closeout wording that keeps edited, tested, fake/local verified, live verified, fixed, and stable claims aligned to evidence, phase-backed closeout wording that makes delivered work, feature/improvement, impact, verification basis, and next phase state visible without overclaiming, and continuation-first execution guidance |
| 2 | answer-presentation.md | answer-presentation.design.md v1.27 | Principle-first, trigger-driven presentation guidance for readable, orderly, and scannable output, including purpose-first framing near the start of diagnosis/test/recommendation/proposal/update answers, compact goal-review presentation support, easy-explanation layout support with plain-language headings, more proactive light readable tables when side-by-side structure materially improves comprehension, compact governing-basis clarification blocks, compact post-compact re-anchor blocks, compact memory-status blocks, narrower next-stage blocks that do not interrupt active execution, compact variable-role structures, compact phase-backed closeout layout for delivered work, feature/improvement, impact, verification, and next phase state, and compact proposal layouts that distinguish advisory future-work ideas from queued execution |
| 3 | anti-mockup.md | anti-mockup.design.md v1.2 | Real systems over mocks with clear proof boundaries for mock/stub use |
| 4 | anti-sycophancy.md | anti-sycophancy.design.md v1.6 | Evidence-seeking proof-aware agreement, disagreement, recommendation, and design posture: truth over pleasing, user preference/direction accepted without factual endorsement, factual agreement requires evidence, ordinary evidence stays grounding input unless it creates a hard constraint, and corrections remain claim-focused when contrary evidence exists |
...
| 20 | native-worker-agent-routing-and-context-control.md | native-worker-agent-routing-and-context-control.design.md v1.3 | First-class owner for intent-first, capability-based, standalone-subagent-first worker routing and leader-context control: pasted logs/paths/snippets are classified by user intent before project exploration, broad independent work prefers focused subagent lanes before leader raw absorption, broad research/design-improvement/source-heavy recommendation work is mapped into focused research lanes, Agent Team workflow remains an exceptional coordination escalation, worker handoffs stay analyzed and proportionate, and leader verification remains mandatory |
...
| 23 | phase-implementation.md | phase-implementation.design.md v2.29 | First-class semantic standard for phased execution planning with early phase-establishment bridge, lineage-first major-vs-subphase selection before opening a fresh major phase, explicit design-to-phase synthesis when sufficiently clear governed design warrants staged execution, inactive `phase/done/` completed-history behavior, current-phase-first and phase-visible live task-list linkage, explicit phase-to-patch linkage when patch is in scope, Development Verification / TestKit Coverage visibility for material phase-backed coding work, phase-backed closeout reporting that states delivered feature/improvement, impact, verification basis, and next phase state when relevant, bounded next-work discovery from the active phase workspace, session-language-aware phase-linked task wording, and an explicit boundary that shared-board/plugin/external coordination mechanics stay outside Main RULES current doctrine |
| 24 | project-documentation-standards.md | project-documentation-standards.design.md v2.35 | Repository-level document-role model plus startup artifact gate, completed documentation surface governance for `phase/done/`, `patch/done/`, and `changelog/done/`, no-default-`design/done/` blueprint boundary, governed companion status for required design/changelog/TODO/phase/patch surfaces, explicit patch-linkage verification for phased work, phase-family lineage visibility without replacing phase identity semantics, live-task-list-vs-durable-TODO split, phase-shaped task creation alignment with visible phase pointers, material Development Verification / TestKit Coverage alignment across governed coding surfaces, execution-discovery surface recognition, runtime installs scoped to the current project/source-owned active runtime rule set, other-owner runtime file boundary, non-default startup patch posture, portable public onboarding/install guidance, portable support assets, and the boundary that shared-board-specific coordination semantics stay outside Main RULES scope |
...
| 28 | safe-file-reading.md | safe-file-reading.design.md v1.4 | Plan-before-read file safety |
...
| 31 | todo-standards.md | todo-standards.design.md v2.24 | Durable TODO governance with startup-establishment bridge, current-phase-first, phase-context-aware, and phase-visible built-in task-list usage for non-trivial live execution tracking, required inspection of relevant governed `/phase` context before task shaping when that context exists, task creation aligned to active phase or clearly implied staged/phase context with visible phase linkage in subject or description, visible verification slices when non-trivial coding implementation and verification are distinct material outcomes, bounded use of already-authored `/phase` planning data for continuity and draft next-work discovery, task wording that follows the actual active session language pattern, same-objective reuse/append retention, completed-task visibility until closure, task-list-first next-work discovery with bounded fallback to broader execution surfaces, live tracking friction recovery so non-material bounded worker lanes do not collapse into leader raw absorption, explicit required TODO synchronization as companion work rather than optional bookkeeping when `TODO.md` is needed, deferral of phase identity allocation to `phase-implementation.md`, and an explicit boundary that shared-board/plugin/external coordination mechanics stay outside Main RULES current doctrine |
...
| 38 | high-signal-communication.md | high-signal-communication.design.md v1.2 | Bounded supplementary high-signal filtering that trims low-value extra content and repeated wording while deferring required-content ownership to the existing communication, explanation, and presentation chains |
| 39 | execution-continuity-and-mode-selection.md | execution-continuity-and-mode-selection.design.md v1.14 | First-class owner for discussion-vs-execution mode selection, intent recheck before project exploration when pasted logs/paths/snippets may be behavior/RULES evidence, startup-gate-first execution boundaries, continuous-execution defaults after startup posture is resolved enough, active next-work discovery from execution surfaces, continuation from implementation into material verification when safe, phase-lineage continuity before new-major phase allocation, visible phase-linkage preservation for continuation-created or continuation-extended phase-backed live tasks, capture-before-continue protection, research-lane decomposition before broad design-improvement/source-comparison continuation, subagent-first worker routing before broad continuation, legitimate stop gates, the boundary that milestone reporting must not replace continued execution, and the boundary that shared-board-specific coordination semantics stay outside Main RULES scope |
...
| 42 | response-closing-and-action-framing.md | response-closing-and-action-framing.design.md v1.2 | First-class owner for concise end-of-response synthesis, clear action framing, recommendation-with-reason wording, alternative preservation, closed-topic summary handling, phase-backed closeout synthesis for delivered work, feature/improvement, impact, verification basis, and next phase state, and advisory goal-qualified proposal framing |
...
| 44 | development-verification-and-debug-strategy.md | development-verification-and-debug-strategy.design.md v1.0 | First-class owner for proportionate coding-time verification strategy, debug signal selection, testing depth, TestKit/scenario decisions, fake/local versus live evidence boundaries, and coding closeout that distinguishes edited, tested, smoke-checked, live-verified, fixed, and stable states |
