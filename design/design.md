...
| 9 | document-consistency.md | document-consistency.design.md v1.12 | Cross-reference validation, source/runtime parity, body sufficiency, shared-destination scope, God-file no-drift checks, and God artifact automation gates |
...
| 39 | execution-continuity-and-mode-selection.md | execution-continuity-and-mode-selection.design.md v1.17 | Execution continuity, next-work discovery, verification continuation, worker routing, and God artifact continuation |
...
| 47 | context-load-and-document-density-control.md | context-load-and-document-density-control.design.md v1.3 | Context lifecycle, density-safe docs, touched God-line repair, God-document prevention, thrash signals, and God Artifact Control Loop |
