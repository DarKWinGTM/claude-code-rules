...
> **Session:** d42465eb-30a7-4bc8-b9d6-03e52306e9a5 (2026-05-11)
...
- active governance docs should avoid God-line history dumps, repair clear low-risk touched God-line candidates, and prevent God-file role overload
...
| 9 | document-consistency.md | document-consistency.design.md v1.11 | Cross-reference validation, source/runtime parity, body sufficiency, shared-destination scope, and God-file no-drift checks |
...
| 12 | document-patch-control.md | document-patch-control.design.md v2.8 | Patch governance, before/after review meaning, inactive `patch/done/`, and God Patch prevention |
...
| 23 | phase-implementation.md | phase-implementation.design.md v2.33 | Phase planning with bounded lineage, compact summaries, phase-visible tasks, verification gates, next-goal closeout, and God Phase prevention |
| 24 | project-documentation-standards.md | project-documentation-standards.design.md v2.39 | Repository document-role model for README, design, changelog, TODO, phase, patch, runtime install scope, and God-file prevention |
...
| 31 | todo-standards.md | todo-standards.design.md v2.27 | Durable TODO governance with compact active entrypoints, referenced history/done shards, phase-visible tasks, and TODO God-file prevention |
...
| 46 | governed-document-rollover-control.md | governed-document-rollover-control.design.md v1.1 | Daily-first rollover for oversized TODO/phase entrypoints, reachable history/done references, and God-document repair routing |
| 47 | context-load-and-document-density-control.md | context-load-and-document-density-control.design.md v1.2 | Context-load lifecycle, density-safe docs, touched God-line repair, God-document prevention, and compact/thrash signals |
