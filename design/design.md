...
| 16 | external-verification-and-source-trust.md | external-verification-and-source-trust.design.md v1.1 | First-class owner for proactive external verification, source-trust ranking, corroboration, source-conflict handling, and current external evidence grounding for recommendation/design judgments without turning ordinary external evidence into an automatic design lock |
...
| 20 | native-worker-agent-routing-and-context-control.md | native-worker-agent-routing-and-context-control.design.md v1.1 | First-class owner for intent-first, capability-based, standalone-subagent-first worker routing and leader-context control: pasted logs/paths/snippets are classified by user intent before project exploration, broad independent work prefers focused subagent lanes before leader raw absorption, Agent Team workflow remains an exceptional coordination escalation, worker handoffs stay analyzed and proportionate, and leader verification remains mandatory |
