...
| 43 | maintainable-code-structure-and-decomposition.md | maintainable-code-structure-and-decomposition.design.md v1.1 | First-class owner for coding-time maintainability as future changeability, responsibility boundaries by reason to change, code-smell triggers rather than verdicts, smallest useful decomposition, helper-function necessity, useful source-code comment discipline, God function/file pressure, wrong-abstraction guardrails, explicit dependency/state boundaries, behavior-preserving refactor posture, and tactical structure-debt convergence without rigid line-count or architecture-template doctrine |
