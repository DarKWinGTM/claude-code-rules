...
The active runtime inventory contains 46 source-owned root rule files.
...
| 28 | safe-file-reading.md | safe-file-reading.design.md v1.5 | Plan-before-read file safety, including oversized governed entrypoint and autocompact-thrash detection before broad active-file absorption |
