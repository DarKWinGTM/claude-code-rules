...
Candidate helper-authority scenarios, unchanged-owner proof, canonical/root installation, annotated `v10.59` tag, GitHub Release identity, and fresh-public-tag checks pass.
